...
\begin{document}
	...
	\begin{tabular}{p{0.6\textwidth}  l}
		...
		3. Die Umgebung hat sofort auf meine Aktionen reagiert. & \usetbl \\
		4. Der Bewegungsmechanismus war sehr nat\"urlich. & \usetbl \\
		5. Ich konnte mich durch die graphische Darstellung stark in das Spiel hinein versetzen. & \usetbl \\
		6. Ich war mir gar nicht mehr \"uber die reale Welt bewusst. & \usetbl \\
		7. Ich konnte alle Folgen meiner Handlungen vorausahnen. & \usetbl \\
		8. Den Display und Controller habe ich so gar nicht wahr genommen. & \usetbl \\
		9. Alle Objekte im virtuellen Bereich haben sich r\"aumlich sehr angenehm bewegt. & \usetbl \\
		10. Die Bewegung in der virtuellen Welt hat mich komplett \"uberzeugt. & \usetbl \\
		11. Ich war komplett an der Erfahrung mit der virtuellen Welt involviert. & \usetbl \\
		12. Ich konnte mich sehr gut mit Ber\"uhrungsgesten umgucken/informieren. & \usetbl \\
		13. Die Bewegungssteuerung war sehr akzeptabel. & \usetbl \\
		14. Ich habe keinerlei Verz\"ogerungen zwischen meinen Bewegungsaktionen und ihren erwarteten Folgen gesp\"urt. & \usetbl \\
		15. Ich konnte mich sehr schnell an das Erlebnis der virtuellen Umwelt anpassen. & \usetbl \\
