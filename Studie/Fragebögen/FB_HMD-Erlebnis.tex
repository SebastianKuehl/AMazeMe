...
\begin{document}
	...
	Bitte kreuzen Sie nachfolgend an, wie sehr Sie den jeweiligen Aussagen zustimmen oder sie ablehnen. M\"ochten Sie sich enthalten, kreuzen Sie bitte den Kreis in der jeweiligen Zeile an.
	
	\rowcolors{2}{}{lighter-gray}
	\hspace{-1.5cm}
	\begin{tabular}{p{0.5\textwidth}  l | c}
		& \printtblhdr	\\ 
		1. Ich konnte alle Ereignisse sehr gut kontrollieren. & \usetbl & O \\
		2. Die Interaktion mit der Umgebung war sehr nat\"urlich. & \usetbl & O \\
		3. Der Bewegungsmechanismus war sehr nat\"urlich. & \usetbl & O \\
		4. Ich war mir gar nicht mehr \"uber die reale Welt bewusst. & \usetbl & O \\
		5. Die Informationen, die ich von meinen Sinnen erhalten habe, waren komplett konsistent. & \usetbl & O \\
		6. Ich konnte alle Folgen meiner Handlungen vorausahnen. & \usetbl & O \\
		7. Ich konnte die komplette Umgebung mit meiner Sicht abscannen.  & \usetbl & O \\
		8. Die Bewegung in der virtuellen Welt hat mich komplett \"uberzeugt. & \usetbl & O \\
		9. Ich war komplett an der Erfahrung mit der virtuellen Welt involviert. & \usetbl & O \\
		10. Die Bewegungssteuerung war sehr akzeptabel. & \usetbl & O \\
		11. Ich habe keinerlei Verz\"ogerungen zwischen meinen Bewegungsaktionen und ihren erwarteten Folgen gesp\"urt. & \usetbl & O \\
		12. Ich konnte mich sehr schnell an das Erlebnis der virtuellen Umwelt anpassen. & \usetbl & O \\
		13. Ich habe mein Zeitgef\"uhl bei der Bearbeitung der Aufgabe komplett verloren. & \usetbl & O \\
	\end{tabular}
